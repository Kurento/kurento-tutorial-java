...
Finally, it can be changed the number of "viewers" connected to the "master" in the one to
many video communication. By default, the number of "viewers" is 3. To do change this number,
user the parameter test.num.viewers:

	mvn verify .... -Dtest.num.viewers=<number>
