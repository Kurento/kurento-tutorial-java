...
/**
 * Simplest Kurento application; the media pipeline is composed by a
 * PlayerEndpoint connected to a filter (FaceOverlay) and an HttpGetEnpoint; the
 * default desktop web browser is launched to play the video.
 * 
